...
| **[context-guard](skills/context-guard/)** | Diagnose Claude Code sessions that saturate your uplink — scan running sessions, tell bufferbloat apart from real hardware faults, add a status line and hook that surface per-turn upload |
